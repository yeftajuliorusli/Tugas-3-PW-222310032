            ...
            <div class="card w-100 w-lg-400px">
                <div class="card-body">
                    <form action="{{ url('sign-in') }}" method="post" id="form-sign-in" onsubmit="handleSignIn(event)">
                        ...
                        <div class="d-grid">
                            <button class="btn btn-lg btn-warning btn-submit fw-bolder" type="submit" id="submit-btn">Sign In</button>
                        </div>
                    </form>
...
<script>
    ...
    const handleSignIn = (event) => {
        ...
        if(email === ""){
            ...
            if(email === "222310032@student.ibik.ac.id" && password === "222310032"){
